...
//                         }
                        ...
                        // Enquanto usar o sr está executando ele não é fechado
                        using (StreamReader sr = new StreamReader("Pedro.txt")){
                            // criando a variavel linha do tipo string
                            // possibilitando a leitura da linha
                            string linha;
        ...
        case "2":
            ...
            novaPj.nome = "EMPRESA 1";
            novaPj.razaoSocial = "Razão Social EMPRESA 1";
            novaPj.cnpj = "90.401.115/0001-40";
